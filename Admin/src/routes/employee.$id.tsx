    ...
    <AppShell>
      <header className="sticky top-0 z-40 bg-surface border-b border-border">
        <div className="flex items-center justify-between px-4 h-14">
          <Link to="/workforce" className="p-2 -ml-2 text-ink"><ArrowLeft className="h-5 w-5" /></Link>
          <h1 className="text-[15px] font-bold text-ink">Employee Details</h1>
          <button className="p-2 -mr-2 text-ink"><Search className="h-5 w-5" /></button>
        </div>
      </header>
      ...
      <div className="px-5 mt-5 space-y-5">
        <section className="relative bg-surface rounded-2xl p-5 shadow-sm overflow-hidden">
          ...
          <div className="relative flex flex-col items-center text-center">
            ...
            <div className="mt-6 w-full border-t border-border pt-5 flex flex-col items-center">
              ...
              <Donut72 />
              <button className="mt-4 px-5 h-10 rounded-full bg-warning text-[11px] font-extrabold tracking-wider text-ink uppercase">Moderate Risk Warning</button>
        ...
        <section className="bg-surface rounded-2xl p-5 shadow-sm">
          <div className="flex items-start justify-between">
            ...
            <div className="flex gap-1">
              <span className="px-3 py-1 rounded-md bg-muted text-[11px] font-bold text-ink">1H</span>
              <span className="px-3 py-1 rounded-md bg-primary text-primary-foreground text-[11px] font-bold">12H</span>
              <span className="px-3 py-1 rounded-md bg-muted text-[11px] font-bold text-ink">24H</span>
            </div>
          </div>
        ...
        <section className="bg-surface-muted rounded-2xl p-5 shadow-sm">
          ...
          <button className="mt-5 w-full h-11 rounded-xl bg-muted text-[12px] font-extrabold tracking-wider text-ink uppercase">Download Full Incident Report</button>
        </section>
