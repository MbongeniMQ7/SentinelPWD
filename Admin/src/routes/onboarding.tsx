    ...
    <AppShell>
      ...
      <div className="px-5 mt-5 space-y-5">
        <form className="bg-surface rounded-2xl p-5 shadow-sm space-y-5">
          ...
          <Link to="/workforce" className="w-full h-13 mt-2 rounded-xl bg-primary text-primary-foreground text-[13px] font-extrabold tracking-wider uppercase flex items-center justify-center gap-2 py-4">
