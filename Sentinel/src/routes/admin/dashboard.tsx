  ...
  return (
    <AppShell>
      ...
      <div className="px-4 lg:px-8 pt-5 pb-28 space-y-5">
        ...
        {/* ── Two-panel row: donut + line chart ── */}
                      ...
                      <td className="py-3 px-2">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-ink-soft text-[11px]">{item.subtitle.split("•")[0].trim()}</p>
                          </div>
                        </div>
                      </td>
        ...
        {/* ── Bottom row: monitoring breakdown + fatigue shortcut ── */}
