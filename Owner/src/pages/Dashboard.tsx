          ...
          <div className="stat-card">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-secondary rounded-full p-1 flex">
                <span className="bg-white shadow text-primary text-xs font-bold px-3 py-1 rounded-full">DAY</span>
            ...
            <div className="flex justify-end">
              <button className="mt-3 h-9 w-9 rounded-tl-xl bg-primary text-white flex items-center justify-center text-xl">+</button>
            </div>
          </div>
        </div>
      </div>
