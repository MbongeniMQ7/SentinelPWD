...
import { Radio, Heart, Activity, Footprints, Play, AlertTriangle, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="app-shell flex flex-col">
      ...
      <main className="flex-1 px-5 pb-6 space-y-5">
        ...
        {/* CTA */}
        <button className="w-full rounded-2xl bg-gold-soft hover:bg-gold/80 py-5 flex items-center justify-center gap-2 text-gold-foreground font-display font-bold text-lg">
          <Play className="h-5 w-5 fill-current" /> Start Monitoring
        </button>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <Link to="/alerts" className="text-xs font-bold tracking-wide text-muted-foreground">
            SEE ALL
          </Link>
        </div>
